  ...
  return (
    <div className="testPageContainer">
      <div className="testLeftSide">
          <div className="testInfoContainer">
              <div className="testMenuBar topHeader">
                    <div style={{display:"flex", alignItems:"center"}}><Link to="/" style={{marginLeft:"10px",marginRight:"10px",color:"black"}}><i className="fa fa-arrow-left fa-lg"></i></Link>{showEventInfo ? <h3>Event Info</h3> : showLogFile ? <h3 style={{paddingLeft:""}}>Transactions Log</h3> : <h3>Tasks Assigned</h3>}</div>
      ...
      <div className={showChatBox ? "testRightSide show" : "testRightSide" }>
        ...
        <div className="chat__headerRight">
          <IconButton>
            ...
            <div className="testPageBody" style={{backgroundImage:"url('chatBackground6.jpeg')"}}>
              <Message send={"yes"} />
              <Message send={"yes"} />
              <Message send={"no"} />
              <Message send={"yes"} />
      ...
      <div className="openChat" onClick={() => setShowChatBox(!showChatBox)}>
        <i className={showChatBox ? "fa fa-times" : "fa fa-comment"} style={{color:"white", fontSize:"25px"}}></i>
      </div>
    </div>
  );
}
